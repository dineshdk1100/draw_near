...
class ThemeMonthService {
  ...
  getThemeMonthsForCurrentLocale() {
    this.themeMonthsMap = jsonDecode(box
        .get('themeMonths_${UserService.instance.locale}', defaultValue: '{}'));
  }
  ...
  void saveThemeMonths(QuerySnapshot<Map<String, dynamic>> snapshots) {
    ...
    box.put('themeMonths_${UserService.instance.locale}',
        jsonEncode(themeMonthsMap));
  }
}
